...
## Installation
This component is compatible with ESPHome 2021.11.0 or later. (For earlier ESPHome versions, please try release 0.4.0 of this component.) To install this component you do not need to download or copy anything, you can just refer to this external component from the yaml file as shown below.
